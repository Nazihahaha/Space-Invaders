...
shooter = dimensions(40, 20, 90, 20) # catcher
...
def draw_box(box):
    global collision,arrow, pause_icon, cross_icon, shooter_x, W_Height, shooter_radius
    ...
    if box == shooter:
        glColor3f(255, 191, 0)  #amber color for the shooter
